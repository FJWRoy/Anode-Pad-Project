...
def save_sd(sims, pad, ax, filename):
    ...
    if float(dictInput['length_incr'])!= 0:
        ...
        ax.plot(L_list, l10_res_list, markersize = 4, label='10th percentile, 7.5% noise', color = 'firebrick')
        ax.plot(L_list, median_res_list,markersize = 4, label='median, 7.5% noise', color = 'black')
        ax.plot(L_list, u10_res_list,markersize = 4, label='90th percentile, 7.5% noise', color = 'firebrick')

        ax.plot(L_list, l10_res_list/7.5,markersize = 4, label='10th percentile, 1% noise', color = 'firebrick')
        ...
        ax.plot(W_list, l10_res_list,markersize = 4, label='10th percentile, 7.5% noise', color = 'firebrick')
        ax.plot(W_list, median_res_list,markersize = 4, label='median, 7.5% noise', color = 'black')
        ax.plot(W_list, u10_res_list,markersize = 4, label='90th percentile, 7.5% noise', color = 'firebrick')

        ax.plot(W_list, l10_res_list/7.5, markersize = 4, label='10th percentile, 1% noise', color = 'firebrick')
        ...
        ax.plot(H_list, l10_res_list, markersize = 4, label='10th percentile, 7.5% noise', color = 'firebrick')
        ax.plot(H_list, median_res_list,markersize = 4, label='median, 7.5% noise', color = 'black')
        ax.plot(H_list, u10_res_list,markersize = 4, label='90th percentile, 7.5% noise', color = 'firebrick')

        ax.plot(H_list, l10_res_list/7.5, markersize = 4, label='10th percentile, 1% noise', color = 'firebrick')
